...
export default function PackageOnboardingModal({ onClose, onComplete }: PackageOnboardingModalProps) {
  ...
  if (showPackageForm) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm transition-all">
        <div className="bg-white dark:bg-gradient-to-br dark:from-[#4B244A] dark:to-[#6B3468] rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-white/20 shadow-2xl transition-all">
          <div className="p-6 border-b border-gray-200 dark:border-white/20">
            <div className="flex items-center justify-between">
              ...
              <button 
                ...
                className="text-gray-400 hover:text-gray-600 dark:text-white/60 dark:hover:text-white text-xl transition-colors"
              >
                ✕
              </button>
            </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm transition-all">
      <div className="bg-white dark:bg-gradient-to-br dark:from-[#4B244A] dark:to-[#6B3468] rounded-3xl max-w-lg w-full border border-gray-200 dark:border-white/20 shadow-2xl overflow-hidden transition-all">
        ...
        <div className="px-8 pb-6">
          <div className="bg-gray-50 dark:bg-white/10 dark:backdrop-blur-xl rounded-2xl p-5 border border-gray-200 dark:border-white/20 mb-6">
