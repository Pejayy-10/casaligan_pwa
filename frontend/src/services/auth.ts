...
export const authService = {
  ...
  async updateProfile(data: { first_name?: string; middle_name?: string; last_name?: string; suffix?: string; profile_picture?: string; email?: string; phone_number?: string }): Promise<UserProfile> {
